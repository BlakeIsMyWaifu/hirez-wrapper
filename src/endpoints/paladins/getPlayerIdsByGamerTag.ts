...
const getPlayerIdsByGamerTag: GetPlayerIdsByGamerTagEndpoint = async (portalId, gamerTag) => await api<GetPlayerIdsByGamerTag>('paladins', 'getplayeridsbygamertag', getPortalId(portalId), gamerTag)
